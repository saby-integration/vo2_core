...
Процедура ОтправитьНажатие(Команда)
	...
	ОбновитьТаблДок_ПозГК();
	ПерегенерироватьВложения();
...
Процедура Записать(Команда)
	...
	МодульОбъектаКлиент().СоставПакета_Записать(СоставПакета, Новый Структура("НеЗапускатьВДокументооборот", Истина));
