...
Процедура сбисУстановитьВидимостьЭлементов(ВходящийКэш)  
	...
	Если НЕ (Кэш.ФормаРаботыСНоменклатурой = "СопоставлениеНоменклатуры_Регистры"
		...
		Если ТипЗнч(ЭтаФорма) = Тип("УправляемаяФорма") И МеханизмРасширенногоСопоставленияЗапущен Тогда
		...
		ИначеЕсли МеханизмРасширенногоСопоставленияЗапущен Тогда
		...
		ИначеЕсли ТипЗнч(ЭтаФорма) = Тип("УправляемаяФорма") И НЕ МеханизмРасширенногоСопоставленияЗапущен Тогда 
