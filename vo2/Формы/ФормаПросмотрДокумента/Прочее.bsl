	...
	Если ЕстьАннулирование  
	   И СоставПакета.Параметры.Свойство("ЕстьАннулирование") Тогда 
		...
		Если СоставПакета.Параметры.ЕстьАннулирование = Неопределено Тогда
			ЕстьАннулирование = МодульОбъектаКлиент().СоставПакета_МожноАннулировать(СоставПакета);
...
&НаКлиенте
Процедура ОбновитьДопПоляДокумента()

	ДопПоляДокумента = МодульОбъектаКлиент().СоставПакета_Получить(СоставПакета, "ДопПараметрыСБИС");
