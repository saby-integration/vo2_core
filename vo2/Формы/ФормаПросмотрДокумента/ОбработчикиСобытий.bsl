...
Процедура УстановитьВидимостьПоВложениюСБИС(ВложениеСБИС)
	...
	Если	ДанныеВложенияРазобраны Тогда	
		...
		ВариантыСопоставления	= МодульТекущий.ПолучитьЭлементФормыОбработки(ЭтаФорма, "Контент.Загрузка.ПанельСопоставлениеНоменклатуры");
		Если ЗагрузкаПоддерживается Тогда
			...
			МодульТекущий.ПолучитьЭлементФормыОбработки(ЭтаФорма, КлючТЧСопоставления + ".Идентификатор").Видимость				= Ложь;
	 		...
	 		МодульТекущий.ПолучитьЭлементФормыОбработки(ЭтаФорма, КлючТЧСопоставления + ".ХарактеристикаПоставщика").Видимость	= Истина;
			МодульТекущий.ПолучитьЭлементФормыОбработки(ЭтаФорма, КлючТЧСопоставления + ".Характеристика").Видимость			= ПараметрыСопоставленияНоменклатурыПросмотр.Видимость.Характеристика;	
		...
		ВариантыСопоставления.ТекущаяСтраница = МодульТекущий.ПолучитьЭлементФормыОбработки(ВариантыСопоставления, КлючВариантаСопоставления);		
