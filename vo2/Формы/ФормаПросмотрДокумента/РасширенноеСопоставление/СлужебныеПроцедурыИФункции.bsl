...
Процедура ЗаполнитьДанныеНоменклатурДляРасширенногоСопоставления(ОбогащенныеДанныеНоменклатурыДляСопоставления = Неопределено)
	...
	Для Каждого ПозицияНоменклатурыКонтрагента Из ТабличнаяЧасть Цикл
		...
		Для Каждого ОбогощеннаяНоменклатура Из ОбогащенныеДанныеНоменклатурыДляСопоставления Цикл
			ОбогощеннаяНоменклатура.Вставить("НеобходимоСопоставление", Ложь);
			ПодготовленныеДанныеНоменклатур.Добавить(ОбогощеннаяНоменклатура);
		КонецЦикла; 
