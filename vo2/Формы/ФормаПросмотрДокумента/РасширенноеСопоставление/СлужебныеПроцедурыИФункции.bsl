...
&НаКлиенте
Процедура ЗаписатьСопоставлениеНоменклатуры_Служебный()
	...
	Вложение.КлассыСопоставленияНоменклатур = ПараметрыДляОбновления.Номенклатура;
	...
	// https://online.sbis.ru/opendoc.html?guid=6c9b8551-df85-4b97-9edc-ee3fc1653952&client=3
	Для Каждого КлассСопоставления Из Вложение.КлассыСопоставленияНоменклатур Цикл
