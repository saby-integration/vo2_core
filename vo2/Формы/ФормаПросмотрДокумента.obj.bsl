...
#Область include_core2_vo2_Формы_ФормаПросмотрДокумента_События_ФормированиеУпаковок
#КонецОбласти

#Область include_core2_vo2_Формы_ФормаПросмотрДокумента_События_ДополнительныеПараметрыДокумента
#КонецОбласти
...
#Область include_core2_vo2_Формы_ФормаПросмотрДокумента_РасширенноеСопоставление_ОбработчикиСобытийФормы 
#КонецОбласти 

#Область include_core2_vo2_Формы_ФормаПросмотрДокумента_private
#КонецОбласти 
...
МассивЗакладок.Добавить("ТранспортныеУпаковки");
