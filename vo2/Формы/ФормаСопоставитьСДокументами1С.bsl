...
#Область include_core_vo2_Формы_ФормаСопоставитьСДокументами1С_public
#КонецОбласти

#Область include_core_vo2_Формы_ФормаСопоставитьСДокументами1С_private
#КонецОбласти

#Область include_core_vo2_Формы_ФормаСопоставитьСДокументами1С_Интерфейс
#КонецОбласти
...
Процедура ТаблицаСопоставленияДокументовВыбор(Элемент, ВыбраннаяСтрока, Колонка, СтандартнаяОбработка)
	...
	ИначеЕсли Лев(ИмяКолонки, 52) = "ТаблицаСопоставленияДокументовСостояниеСопоставления" Тогда
		...
		ИначеЕсли	СбисТекущиеДанные.СостояниеСопоставления = 5 Тогда
			...
			фрм.Показать(МестныйКэш, СбисТекущиеДанные.ДанныеСравнения[0].Значение);
		КонецЕсли;
...
#Область include_core_vo2_Формы_ОбщиеМеханизмы_ОписаниеОповещенияОЗакрытии
#КонецОбласти
