...
Процедура ТаблицаСопоставленияДокументовДокумент1СОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	...
	Если ТипЗнч(ВыбранноеЗначение) = Тип("Тип") Тогда
		Попытка
			...
			СторонаКонтрагента	= МодульОбъектаКлиент().СоставПакета_Получить(оДокумент, "Контрагент");
			ОтборКонтрагент		= МодульОбъектаКлиент().Сторона_НайтиКарточки1С(СторонаКонтрагента, "Контрагент");
		...
		Исключение
			Ошибка = МодульОбъектаКлиент().НовыйСбисИсключение(
				ИнформацияОбОшибке(),
				"ФормаСопоставитьСДокументами1С.ТаблицаСопоставленияДокументовДокумент1СОбработкаВыбора");
			МодульОбъектаКлиент().СбисСообщить(Ошибка);
