...
Функция ПроверитьИПрименитьПараметрыПередЗакрытием(ПараметрыНовые, Отказ)
	...
	Если Кэш.СБИС.Свойство("ОбменВключен") И Не Кэш.СБИС.ОбменВключен Тогда
	...
	Если ПараметрыНовые.СпособОбмена <> НастройкиПодключения_Было.СпособОбмена Или Не Кэш.СБИС.ОбменВключен Тогда
