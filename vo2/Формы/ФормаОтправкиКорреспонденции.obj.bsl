...
Процедура ДобавитьВложение(Команда)
	...
	ОбработкаДиалога = МодульОбъектаКлиент().НовыйСбисОписаниеОповещения("ПослеВыбораФайлов", ЭтаФорма);
	МодульОбъектаКлиент().CбисВыбратьФайл(ОбработкаДиалога, ПараметрыВыбора);
