...
Функция сбисСписокЛокальныхСертификатов(Кэш, ТекстОшибки) Экспорт
	...
	Исключение
		...
		ОшибкаЧтенияСертификатов = МодульОбъектаКлиент().НовыйСбисИсключение(ИнформацияОбОшибке(), "ЭлектроннаяПодписьНаСервере.сбисСписокЛокальныхСертификатов");
		МодульОбъектаКлиент().СбисСообщить(ОшибкаЧтенияСертификатов);
		ТекстОшибки = МодульОбъектаКлиент().СбисИсключение_Выгрузить(ОшибкаЧтенияСертификатов, "Сообщение");
...
Функция сбисПодписатьФайл(Кэш, ПолноеИмяФайла, Сертификат, Алгоритм, ТекстОшибки) Экспорт
	...
	Исключение
		...
		ОшибкаПодписания = МодульОбъектаКлиент().НовыйСбисИсключение(ИнформацияОбОшибке(), "ЭлектроннаяПодписьНаСервере.сбисПодписатьФайл");
		МодульОбъектаКлиент().СбисСообщить(ОшибкаПодписания);
		ТекстОшибки = МодульОбъектаКлиент().СбисИсключение_Выгрузить(ОшибкаПодписания, "Сообщение");
		Подпись = Ложь;
