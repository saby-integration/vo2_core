...
Процедура ЗаполнитьДеревоОшибок_ДокументСБИС(СтрокаДерева, СтруктураДанныхОшибки)
	...
	Если СтруктураДанныхОшибки.Свойство("ОбработанДокумент1С") И ЗначениеЗаполнено(СтруктураДанныхОшибки.ОбработанДокумент1С) Тогда
		...
		Если ТипЗнч(СтруктураДанныхОшибки.СтруктураОшибки.help) = Тип("Структура") Тогда 
			Если СтруктураДанныхОшибки.СтруктураОшибки.help.type = "url" Тогда
				ОшибкаЭлемент.РешениеОшибки = "Решение ошибки";
				ОшибкаЭлемент.СсылкаНаРешение		= СтруктураДанныхОшибки.СтруктураОшибки.help.action;
				ОшибкаЭлемент.ТекстОшибки 			= СтруктураДанныхОшибки.СтруктураОшибки.help.text;
			КонецЕсли;
		ИначеЕсли ЗначениеЗаполнено(СтруктураДанныхОшибки.СтруктураОшибки.help) Тогда         
			ОшибкаЭлемент.СсылкаНаРешение		= СтруктураДанныхОшибки.СтруктураОшибки.help;
			ОшибкаЭлемент.РешениеОшибки = "Решение ошибки";
		Иначе
			ОшибкаЭлемент.РешениеОшибки = "Сохранить данные об ошибке";
		КонецЕсли;
	...
	Если СуществующаяСтрокаСДетализациейОшибки = Неопределено Тогда
		...
		Если ТипЗнч(СтруктураДанныхОшибки.СтруктураОшибки.help) = Тип("Структура") Тогда 
			Если СтруктураДанныхОшибки.СтруктураОшибки.help.type = "url" Тогда
				...
				СтрокаДереваЭлемент.СсылкаНаРешение		= СтруктураДанныхОшибки.СтруктураОшибки.help.action;
				СтрокаДереваЭлемент.ТекстОшибки 			= СтруктураДанныхОшибки.СтруктураОшибки.help.text;
			КонецЕсли;
		ИначеЕсли ЗначениеЗаполнено(СтруктураДанныхОшибки.СтруктураОшибки.help) Тогда         
			СтрокаДереваЭлемент.СсылкаНаРешение		= СтруктураДанныхОшибки.СтруктураОшибки.help;
			СтрокаДереваЭлемент.РешениеОшибки = "Решение ошибки";
		Иначе
