	...
	Для Каждого Элемент Из РезультатОтправки.ТипыОшибок Цикл
		...
		Если ЭлементСоответствия <> Неопределено Тогда
			...
			Для Каждого СтруктураДанныхОшибки Из ЭлементСоответствия Цикл
				...
				СуществующаяСтрокаСДокументомСБИС = ТипыОшибокПереопределяемый.Строки.Найти(СтруктураДанныхОшибки.ДокументСБИС, "ДокументСБИС", Истина);
				Если СуществующаяСтрокаСДокументомСБИС <> Неопределено Тогда
					...
					ИначеЕсли СтруктураДанныхОшибки.СтруктураОшибки.code = 340 Тогда
						СтруктураДанныхОшибки.Сообщение = "Фатальная ошибка ФЛК. Двойной клик покажет/скроет подробный отчёт";
					КонецЕсли;  
				...
				Иначе
					...
					Если СтруктураДанныхОшибки.СтруктураОшибки.code = 729 Тогда
						...
						ОшибкаЭлемент.ДокументСБИС = СтруктураДанныхОшибки.НазваниеВложения; 
						ОшибкаЭлемент.КодОшибки	   = СтруктураДанныхОшибки.СтруктураОшибки.code;
					ИначеЕсли СтруктураДанныхОшибки.СтруктураОшибки.code = 340 Тогда
