...
Процедура ЗаполнитьДеревоОшибок_ДокументСБИС(СтрокаДерева, СтруктураДанныхОшибки)
	...
	ИначеЕсли СтруктураДанныхОшибки.СтруктураОшибки.code = 340 Тогда
			
		ОшибкаЭлемент.ТекстОшибки  = "Фатальная ошибка ФЛК. Двойной клик покажет/скроет подробный отчёт";
		ОшибкаЭлемент.ДокументСБИС = ДетализацияДокументСБИС; 
		ОшибкаЭлемент.КодОшибки	   = СтруктураДанныхОшибки.СтруктураОшибки.code;	
