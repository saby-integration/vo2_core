...
Процедура СбисУстановитьФорму(ПараметрыОткрытия)
	...
	ПараметрыФормы.Вставить("Раздел", РазделФильтра);
...
Процедура СбисУстановитьФорму_ФормаГлавноеОкноНоменклатура(ПараметрыОткрытия)
	...
	Для каждого Фильтр Из ПараметрыФильтра Цикл
		...
		Изменения = Новый Структура("УстановитьОграничениеТипа");
		Если НЕ ТипыПолейФильтра.Свойство(Фильтр.Ключ, Изменения.УстановитьОграничениеТипа) Тогда
			Изменения.УстановитьОграничениеТипа = ОписаниеСтроки;
		КонецЕсли;
	...
	Изменения = Новый Структура("ВыборГруппИЭлементов", "Группы");
	МодульОбъектаКлиент().ИзменитьЭлементФормыОбработки(ОписаниеИзменить, Изменения);
