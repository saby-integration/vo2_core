...
Процедура ЗаполнитьРезультатРучногоСопоставления(ДанныеРучногоСопоставления)
	...
	Номенклатуры1С = МодульОбъектаСервер().СериализоватьОбъектДляВозвратаНаКлиент(ТаблицаНоменклатур1С);
	Для Каждого ДанныеНоменклатуры1С Из Номенклатуры1С Цикл 	
		...
		ВходящиеДанные = Новый Структура("Источник", ДанныеНоменклатуры1С.Единицы);      
		...
		МодульОбъектаСервер.СопоставлениеДляЕдиницыСервер_Вставить(СтруктураЕдиницы, "Владелец", ДанныеНоменклатуры1С.Номенклатура);
		
		
		Если ЗначениеЗаполнено(ДанныеНоменклатуры1С.Коэффициент) Тогда
			СтруктураЕдиницы.Коэффициент = ДанныеНоменклатуры1С.Коэффициент;
		КонецЕсли;
		
		
		ДанныеНоменклатуры1С.Вставить("ЕдИзм1С", Новый Соответствие);
		ДанныеНоменклатуры1С.ЕдИзм1С.Вставить(ДанныеНоменклатуры1С.Единицы, СтруктураЕдиницы);                                                                                                                                       
