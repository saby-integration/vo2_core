...
Процедура СбисУстановитьФорму(ПараметрыОткрытия)
	...
	// v8unpack #Область СправочникиНоменклатурыИЕдиниц
	...
	ПараметрыИзменить = Новый Структура("УстановитьОграничениеТипа", Новый ОписаниеТипов(ТипСправочникаНоменклатуры));
	...
	ПараметрыИзменить = Новый Структура("УстановитьОграничениеТипа", Новый ОписаниеТипов(ТипСправочникаЕдиницаИзмерения));
	МодульОбъектаКлиент().ИзменитьЭлементФормыОбработки(ОписаниеПараметраИзменить, ПараметрыИзменить);
	
	ДанныеРучногоСопоставления = ПараметрыОткрытия.ОсновныеДанные;
	// v8unpack #КонецОбласти // Справочники номенклатуры и единиц
