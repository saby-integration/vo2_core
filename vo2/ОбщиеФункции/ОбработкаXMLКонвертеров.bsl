...
Функция сбисПрименитьXSLT(Кэш, ШаблонXML, ИмяXSLT, ДопПараметры, Отказ) Экспорт
	...
	Исключение
		...
		Отказ = Истина;
		РезультатПреобразования = МодульОбъектаКлиент().НовыйСбисИсключение(ИнформацияОбОшибке(), "ОбщиеФункции.сбисПрименитьXSLT", 770, "Ошибка XSLT", "Возникла ошибка при выполнении преобразования.",
