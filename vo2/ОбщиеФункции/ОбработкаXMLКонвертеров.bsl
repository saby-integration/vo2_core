...
Функция сбисИмяXSLTДляВложения(Кэш, СтруктураФайла, сбисДополнительныеПараметры) Экспорт
	...
	Результат.Добавить(ИмяXSLT);
	
	// Новый формат с исходной версией и итоговой
	ИмяXSLT = СбисФорматСтроки(Файл_Формат + "_" + ПодТип + "_" + Файл_ВерсияФормата + "_" + ВложениеСБИС_ВерсияФормата, "КлючСтруктуры");
