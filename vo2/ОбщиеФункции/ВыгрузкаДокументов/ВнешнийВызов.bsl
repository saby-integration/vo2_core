...
Функция ПолучитьДанныеДокумента1С(СтруктураИниФайла, Документ, КэшЗначенийИни, КэшПарам=Неопределено) Экспорт // alo Меркурий
	...
	Контекст = Новый Структура("Параметры, Переменные, Документ, Ини, ДанныеИсточник");
	Контекст.Параметры		= Новый Структура("ВычислитьФункции", Ложь);
	Контекст.Ини			= Новый Структура;
	Контекст.Переменные		= Новый Структура;
	Контекст.ДанныеИсточник	= Новый Структура("ОсновнойОбъект", Документ);
