...
Функция СгенерироватьИсходящийПакет(ПакетВходящий, ПараметрыГенерацииПакета)
	...
	Результат.ПолныйСоставПакета.Вставить("НашаОрганизация", 			МодульОбъектаКлиент().ВложениеСБИС_СторонаПоРоли(ОснованиеДляПакета, "Отправитель"));
	Результат.ПолныйСоставПакета.Вставить("Контрагент", 				МодульОбъектаКлиент().ВложениеСБИС_СторонаПоРоли(ОснованиеДляПакета, "Получатель"));
