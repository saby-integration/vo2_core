...
Функция сбисПолучитьНомерДокумента(Контекст) Экспорт 
	...
	НомерНаПечать =  сбисНомерДокументаНаПечатьСервер(сбисФункцияНомераНаПечать(МестныйКэш), 
						сбисДокумент, ОсновнойНомерДокумента, сбисДобавитьЗначениеПослеНомера(Контекст));
						
	Возврат МодульОбъектаКлиент().ПривестиТипСбис(НомерНаПечать, "Строка");					
...
Функция ПолучитьНомерДокумента(Контекст) Экспорт  
	...
	НомерНаПечать = сбисНомерДокументаНаПечатьСервер(сбисФункцияНомераНаПечать(МестныйКэш), 
						Контекст.Документ, сбисНомерДокумента, сбисДобавитьЗначениеПослеНомера(Контекст)); 
...
Функция сбисНомерИсходногоДокументаНаПечать(Контекст) Экспорт
	...
	НомерНаПечать = сбисНомерДокументаНаПечатьСервер(сбисФункцияНомераНаПечать(МестныйКэш), Контекст.ИсходныйДокумент); 
...
Функция сбисНомерОснованияНаПечать(Контекст) Экспорт 
	...
	НомерНаПечать = сбисНомерДокументаНаПечатьСервер(сбисФункцияНомераНаПечать(МестныйКэш), 
						Контекст.ДокОснование, , сбисДобавитьЗначениеПослеНомера(Контекст));
...
Функция сбисНомерИсходнойФактурыНаПечать(Контекст) Экспорт
	...
	НомерНаПечать = сбисНомерДокументаНаПечатьСервер(сбисФункцияНомераНаПечать(МестныйКэш), Контекст.ИсходнаяФактура); 
