...
&НаКлиенте
Функция СложитьСтрокиПриСвертке(Кэш, Ошибка, КолонкаСуммированияМассив, НайденаяСтрока, СуммируемаяСтрока) Экспорт    // TO DO Ду-Ду. Чья-то копипаста. Сравнить с БСП и вынести в МодульОбъектаКлиент
...
&НаКлиенте
Функция СложитьЗначенияСветкиСтрок(Кэш, ИмяЗначения, ПервоеЗначение, ВтороеЗначение) Экспорт   // TO DO Ду-Ду. Чья-то копипаста. Сравнить с БСП и вынести в МодульОбъектаКлиент
	Результат = "";
...
&НаКлиенте
Функция НайтиСтрокуВМассивеСтруктурИмяЗначение(Имя, МассивПоиска) Экспорт // TO DO Ду-Ду. Чья-то копипаста. Сравнить с БСП и вынести в МодульОбъектаКлиент
