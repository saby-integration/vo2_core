...
&НаКлиенте
Процедура ЗаполнитьВложенияИзСоставаПакетаНаПечать(СписокДляВыбора, Знач СоставПакета)
...
Функция СбисМассоваяПечать(ОбъектыПечати, ДополнительныеПараметры) Экспорт
	...
	Для Каждого ОбъектПечати Из ОбъектыПечати Цикл
		...
		ПараметрыЗапросаФайла.ИмяФайла	= МодульОбъектаКлиент.НовыйВременныйФайлКлиент(, "pdf");
		...
		// Не освобождаем файлы, т.к. они могут не сразу отправиться на печать. Пусть сами освобождаются, по истечении срока годности в 10 минут
		//МодульОбъектаКлиент.ОсвободитьВременныйФайл(ПараметрыЗапросаФайла.ИмяФайла);
