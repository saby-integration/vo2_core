	...
	Иначе
		...
		Исключение
			...
			Возврат Новый Структура("code,message,details", 772, "Ошибка работы с файловой системой",
																	"У вас нет прав доступа для работы с установленным каталогом настроек.
																	| Смените место хранения настроек или обратитесь к администратору для настройки прав.");
		КонецПопытки;
	КонецЕсли;
