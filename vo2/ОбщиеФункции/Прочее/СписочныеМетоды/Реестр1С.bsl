...
Функция ЗаполнитьМассивЭлементовСправочника(ТекстЗапроса, ПараметрыФильтра) Экспорт
	...
	ПараметрыЗаполнения.Вставить("Выборка", РезультатЗапроса.Выбрать(ОбходРезультатаЗапроса.ПоГруппировкамСИерархией));
...
Процедура ЗаполнитьМассивЭлементовСправочникаИерархически(ПараметрыЗаполнения) Экспорт
	...
	Выборка = ПараметрыЗаполнения.Выборка;
	...
	Пока Выборка.Следующий() Цикл
		...
		ПараметрыЗаполненияПодстрок.Вставить("Выборка", Выборка.Выбрать(ОбходРезультатаЗапроса.ПоГруппировкамСИерархией));
