...
Функция сбисПолучитьСтавкуНДС_Перечисление_НаСервере(Знач сбисСтавка)
	Если		(Найти(сбисСтавка,"22/122") = 1) Или (сбисСтавка = "22") Тогда
		Попытка
	...
	ИначеЕсли	(Найти(сбисСтавка,"5/105") = 1) Или (сбисСтавка = "5") Тогда
		Попытка
		...
		Исключение
			...
			Возврат Неопределено;
		КонецПопытки;
	ИначеЕсли	(Найти(сбисСтавка,"7/107") = 1) Или (сбисСтавка = "7") Тогда
		Попытка
