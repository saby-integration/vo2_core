...
Функция ЗаполнитьДанныеДляЗагрузкиПоУмолчанию(Кэш, СоставПакета, Вложение, ДополнительныеПараметры=Неопределено) Экспорт     	
	...
	СтрОрганизации.Вставить("ИдентификаторЛица", ИдентификационныйНомерОрганизации);
	СтрКонтрагента.Вставить("ИдентификаторЛица", ИдентификационныйНомерКонтрагента);
