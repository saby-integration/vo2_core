...
Функция СбисНайтиПодходяшийДокументДляВложения(Контекст) Экспорт
	...
	Если МодульОбъектаКлиент().ВложениеСБИС_Получить(ВложениеСБИС, "Статус") = "Разобран" Тогда
		ПараметрыПоискаОснований = Новый ФиксированнаяСтруктура("СоставПакета, Режим", Контекст.СоставПакета, "Документ");
...
Функция СбисНайтиПодходящееОснованиеДляВложения(Контекст) Экспорт
	...
	ВложениеСБИС = Контекст.Вложение;
	 ...
	 // Поиск можно проводить только по разобранному вложению, т.к. иначе будет рекурсивное зацикливание
	Если МодульОбъектаКлиент().ВложениеСБИС_Получить(ВложениеСБИС, "Статус") = "Разобран" Тогда
		ПараметрыПоискаОснований = Новый ФиксированнаяСтруктура("СоставПакета, Режим", Контекст.СоставПакета, "Основание");
		Возврат МодульОбъектаКлиент().ВложениеСБИС_Получить(ВложениеСБИС, "ПодходящийДокумент", ПараметрыПОискаОснований);
	КонецЕсли;
