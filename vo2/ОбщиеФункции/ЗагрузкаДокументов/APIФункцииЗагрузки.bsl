...
Функция сбисРассчитатьЦену(Контекст) Экспорт
	...
	Если	Не ((СтрТабл.Свойство("СуммаНДС", СуммаНДС)
		...
		СуммаНДС = 0;
	КонецЕсли;
	ПараметрыРасчета.Вставить("СуммаНДС", Число(СуммаНДС));
	...
	Если	СтрТабл.Свойство("СуммаСНДС", СуммаСНДС)
		...
		ПараметрыРасчета.Вставить("СуммаСНДС",		Число(СуммаСНДС));
		ПараметрыРасчета.Вставить("СуммаБезНДС",	Число(СуммаСНДС) - ПараметрыРасчета.СуммаНДС);
		
	ИначеЕсли	СтрТабл.Свойство("СуммаБезНал", СуммаБезНДС)
				ИЛИ СтрокаФайла.Свойство("СуммаБезНал", СуммаБезНДС) Тогда
				
		ПараметрыРасчета.Вставить("СуммаСНДС",		Число(СуммаБезНДС));
		ПараметрыРасчета.Вставить("СуммаБезНДС",	Число(СуммаБезНДС));
	Иначе
	...
	Если	(СтрТабл.Свойство("Количество", Количество)
			...
			И Число(Количество) <> 0 Тогда
			
		ПараметрыРасчета.Вставить("Количество", Число(Количество));
	Иначе
