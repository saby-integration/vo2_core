...
Функция СбисРассчитатьСуммуСУчетомНДС(Контекст) Экспорт
	...
	Иначе
		...
		СуммаВключаетНДС = Контекст.Переменные.ПараметрыНДС.СуммаВключаетНДС;
		
	КонецЕсли;
	
	СуммаСНДС			= РассчитатьЗначение("ТаблДок_Сумма",		Контекст.Ини);
	СуммаБезНДС			= РассчитатьЗначение("ТаблДок_СуммаБезНал",	Контекст.Ини);
	СуммаНДС			= РассчитатьЗначение("ТаблДок_СуммаНДС",	Контекст.Ини);
