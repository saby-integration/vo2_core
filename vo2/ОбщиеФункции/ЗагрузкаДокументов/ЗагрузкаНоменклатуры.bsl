...
&НаСервере
Процедура АвтоматическоеСопоставлениеНоменклатур(ПодготовленныеДанныеНоменклатур, ПараметрыПоиска)

	ПараметрыСопоставленияПоРеквизитам = СопоставитьРеквизитыПоискаСМетаданными(ПараметрыПоиска);
	...
	Если ПараметрыСопоставленияПоРеквизитам.Количество() Тогда 
		...
		ПоискСопоставленийПоРеквизитамСправочника(ПодготовленныеДанныеНоменклатур, ПараметрыПоиска);
	КонецЕсли;
	
	ПоискСопоставленийПоДополнительнымСведениям(ПодготовленныеДанныеНоменклатур, ПараметрыПоиска);
	
КонецПроцедуры

&НаСервереБезКонтекста
Функция СопоставитьРеквизитыПоискаСМетаданными(ПараметрыПоиска)
...
&НаСервере
Процедура ПоискСопоставленийПоРеквизитамСправочника(ПодготовленныеДанныеНоменклатур, ПараметрыПоиска)
	...
	Для Каждого СтрокаНоменклатуры Из ПодготовленныеДанныеНоменклатур Цикл
		...
		Для Каждого ПараметрПоиска Из РеквизитыСправочника Цикл
			...
			Для Каждого Номенклатура1С Из НайденнаяНоменклатура Цикл          
				...
				ВалидацияАвтоматическогоСопоставления(СтрокаНоменклатуры, ПараметрыПоиска);
...
&НаСервере
Процедура ПоискСопоставленийПоДополнительнымСведениям(ПодготовленныеДанныеНоменклатур, ПараметрыПоиска) 
