...
Процедура сбисВыйти() Экспорт
	...
	формаАвторизации		= МодульОбъектаКлиент().ПолучитьФормуОбработки("ФормаАвторизация");
	
	формаАвторизации.ОписаниеОповещенияОЗакрытии = ОбработчикПосле;
	формаАвторизации.ПоказатьПоверх();
