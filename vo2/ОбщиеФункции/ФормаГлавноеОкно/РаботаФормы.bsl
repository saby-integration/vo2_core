...
Процедура ПоказатьСогласованиеЦен(ЛокальныйКэш = Неопределено, сбисПараметрыОбработчика = Неопределено) Экспорт
	...
	ЭлементДата = Новый Структура("Имя, Заголовок, Тип", "ТипДокумента", "Тип документа", Новый ОписаниеТипов("Строка"));
	МодульОбъектаКлиент().КонструкторФорм_ДобавитьЭлемент(КонструкторФорм, ЭлементДата);
	СписокДоступныхЗначений = Новый СписокЗначений;
	СписокДоступныхЗначений.Добавить("Согласование цен", "Согласование цен");
	СписокДоступныхЗначений.Добавить("Согласование цен Тандер", "Согласование цен Тандер");
	СписокДоступныхЗначений.Добавить("Согласование цен Виктория Балтия", "Согласование цен Виктория Балтия");
	СписокДоступныхЗначений.Добавить("Согласование цен от сети МОЛЛ", "Согласование цен от сети МОЛЛ");
	СписокДоступныхЗначений.Добавить("Согласование цен ВсеИнструменты", "Согласование цен ВсеИнструменты"); 
	СписокДоступныхЗначений.Добавить("Согласование цен X5", "Согласование цен X5"); 
	СписокДоступныхЗначений.Добавить("Согласование цен Дикси", "Согласование цен Дикси"); 
	СписокДоступныхЗначений.Добавить("Импорт остатков ""Русский свет""", "Импорт остатков ""Русский свет""");
...
Процедура ПоказатьСогласованиеЦен_Продолжить(Результат, ДопПараметры) Экспорт
	...
	Документ1С.Вставить("Регламент", Результат.ТипДокумента); 
