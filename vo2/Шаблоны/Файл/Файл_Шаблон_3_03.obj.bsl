	...
	Попытка	
		...
		Если МодульОбъектаКлиент().ПолучитьЗначениеФичи("РасширенныйФункционалСопоставленияНоменклатуры") Тогда    
			...
			Если ЗначениеЗаполнено(Основание) Тогда
				...
				МодульОбъектаКлиент().ВложениеСБИС_Заполнить(Вложение, "ФормаОбратногоСопоставления", "ФормаСопоставленияНоменклатуры");
				МодульОбъектаКлиент().ВложениеСБИС_Заполнить(Вложение, Контекст.ИспользоватьСопоставлениеНоменклатуры, "ИспользоватьСопоставлениеНоменклатуры");
			КонецЕсли;
