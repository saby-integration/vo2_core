	...
	Попытка	
		...
		Если МодульОбъектаКлиент().ПолучитьЗначениеФичи("РасширенныйФункционалСопоставленияНоменклатуры") Тогда    
            ...
            Если ЗначениеЗаполнено(Основание) Тогда
                ...
                Сообщить("Номер заказа: " + ДанныеОснования.Номер + ", дата заказа: " + ДанныеОснования.Дата);
...
Функция СформироватьРасхождениеНаСервере(СтруктураФайлаКонтрагента, СтруктураФайлаНаша) Экспорт
	...
	Для Каждого СтрокаСоответствия Из ТабЧастьКонтрагента Цикл
		...
		Иначе
			Если ЗначениеЗаполнено(Номенклатура) или ЗначениеЗаполнено(ХарактеристикаНоменклатуры) Тогда 
