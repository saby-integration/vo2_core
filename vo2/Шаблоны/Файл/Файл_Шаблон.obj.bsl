	...
	Для Каждого СтрокаСоответствия Из ТабЧастьКонтрагента Цикл
		...
		Если НайденныеСтроки.Количество()>0 Тогда 
			...
			Для Каждого НайденнаяСтрока из НайденныеСтроки Цикл  
				...
				Иначе   
					Попытка
						НоваяСтрока.Кол_во = Число(НоваяСтрока.Кол_во) + НайденнаяСтрока.Кол_во;
						НоваяСтрока.Сумма = Число(НоваяСтрока.Сумма) + НайденнаяСтрока.Сумма;   
						НоваяСтрока.СуммаБезНал = Число(НоваяСтрока.СуммаБезНал) + НайденнаяСтрока.СуммаБезНал;
						НоваяСтрока.НДС.Сумма = Число(НоваяСтрока.НДС.Сумма) + НайденнаяСтрока.НДС.Сумма;
					Исключение
					КонецПопытки;
				КонецЕсли;
