...
Процедура ОбработчикДанных_ЗаполнитьСтрокуТабличнойЧастиДокумента(Аргумент, ДопПараметры) Экспорт
	...
	Если ПроверитьКоличество(КоличествоИзДокОснования, СуммаЦенБезНДСДо, СуммаЦенДо, ТекСтрока) Тогда
		...
		Если ТоварнаяРазница > 0 Тогда
			Файл_Шаблон_Модуль.УстановитьЗначениеПоКлючу(ТекДанные, "КоличествоНедостача", 	Файл_Шаблон_Модуль.ГенераторПривестиТип(ТоварнаяРазница, "Количество"));
			Файл_Шаблон_Модуль.УстановитьЗначениеПоКлючу(ТекДанные, "СуммаНДСНедостача", 	Файл_Шаблон_Модуль.ГенераторПривестиТип(СуммаЦенБезНДСДо - ТекДанные.Получить("СуммаЦенБезНДС"), "Сумма")); 
			Файл_Шаблон_Модуль.УстановитьЗначениеПоКлючу(ТекДанные, "СуммаЦенНедостача", 	Файл_Шаблон_Модуль.ГенераторПривестиТип(СуммаЦенДо - ТекДанные.Получить("СуммаЦен"), "Сумма"));
		ИначеЕсли ТоварнаяРазница < 0 Тогда
			Файл_Шаблон_Модуль.УстановитьЗначениеПоКлючу(ТекДанные, "КоличествоИзлишки", Файл_Шаблон_Модуль.ГенераторПривестиТип((ТоварнаяРазница * -1), "Количество"));
			Файл_Шаблон_Модуль.УстановитьЗначениеПоКлючу(ТекДанные, "СуммаНДСИзлишки", 	Файл_Шаблон_Модуль.ГенераторПривестиТип((СуммаЦенБезНДСДо - ТекДанные.Получить("СуммаЦенБезНДС")) * -1, "Сумма"));
			Файл_Шаблон_Модуль.УстановитьЗначениеПоКлючу(ТекДанные, "СуммаЦенИзлишки", 	Файл_Шаблон_Модуль.ГенераторПривестиТип((СуммаЦенДо - ТекДанные.Получить("СуммаЦен")) * -1, "Сумма"));
		КонецЕсли;
	КонецЕсли;
