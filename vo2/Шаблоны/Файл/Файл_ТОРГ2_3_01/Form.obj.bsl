...
Процедура ОбработчикДанных_ЗаполнитьСтрокуТабличнойЧастиДокумента(Аргумент, ДопПараметры) Экспорт
	...
	Если ПроверитьКоличество(КоличествоИзДокОснования, СуммаЦенБезНДСДо, СуммаЦенДо, ТекСтрока) Тогда
		ТоварнаяРазница = Число(КоличествоИзДокОснования) - Число(ТекСтрока.Кол_во);
		Если ТоварнаяРазница > 0 Тогда
			...
			Иначе
				Файл_Шаблон_Модуль.УстановитьЗначениеПоКлючу(ТекДанные, "СуммаНДСНедостача", 	
				Файл_Шаблон_Модуль.ГенераторПривестиТип(СуммаНДСДо - ТекДанные.Получить("СуммаНДС"), "Сумма"));
			КонецЕсли;
			Файл_Шаблон_Модуль.УстановитьЗначениеПоКлючу(ТекДанные, "СуммаЦенНедостача", 
			Файл_Шаблон_Модуль.ГенераторПривестиТип(СуммаЦенДо - ТекДанные.Получить("СуммаЦен"), "Сумма"));
		ИначеЕсли ТоварнаяРазница < 0 Тогда
			...
			Иначе
				Файл_Шаблон_Модуль.УстановитьЗначениеПоКлючу(ТекДанные, "СуммаНДСИзлишки", 	
				Файл_Шаблон_Модуль.ГенераторПривестиТип((СуммаНДСДо - ТекДанные.Получить("СуммаНДС")) * -1, "Сумма"));
			КонецЕсли;
			Файл_Шаблон_Модуль.УстановитьЗначениеПоКлючу(ТекДанные, "СуммаЦенИзлишки", 	
			Файл_Шаблон_Модуль.ГенераторПривестиТип((СуммаЦенДо - ТекДанные.Получить("СуммаЦен")) * -1, "Сумма"));
		КонецЕсли;
	КонецЕсли;
