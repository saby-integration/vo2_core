...
Функция СбисИсключение_КодПоAPIСБИС(КодApiSBIS) Экспорт
	...
	КодApiSBIS_28 = Лев(ВРег(КодApiSBIS), 28);	
	...
	ИначеЕсли   КодApiSBIS = "{00000000-0000-0000-0000-1FA000001001}" Тогда
		Возврат 305;
	ИначеЕсли   КодApiSBIS = "{00000000-0000-0000-0000-1FA0000A0001}" Тогда
		Возврат 346; 
	ИначеЕсли   КодApiSBIS = "{00000000-0000-0000-0000-1AA0000F1002}" Тогда
		Возврат 356; 
	ИначеЕсли   КодApiSBIS = "{00000000-0000-0000-0000-1AA000001000}" Тогда
		Возврат 357; 
