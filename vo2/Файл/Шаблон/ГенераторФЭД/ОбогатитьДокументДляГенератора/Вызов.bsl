...
Процедура ЗаполнитьПоДокументОснование(Док, Кэш) Экспорт
	Перем НазваниеУстановить, НомерУстановить, ДатаУстановить, НаборОснованийУстановить, ПараметрыФормирования;
...
Процедура ЗаполнитьПоДокументОснование_СопрДокФХЖ(ПараметрыФормирования);
	...
	ОснованиеДобавить = Новый Структура("Номер, Дата, Название",
		НомерУстановить,
