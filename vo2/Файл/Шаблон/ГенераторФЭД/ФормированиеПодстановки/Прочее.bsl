...
//
&НаКлиенте
Функция ГенераторПривестиТип(ЗначениеПриведения, КлючПриведения = Неопределено) Экспорт
...
Процедура УстановитьПризнакДобавленияСтроки(Аргумент, ДопПараметры) Экспорт
	...
	Попытка
		Количество = ТипЧисла.ПривестиЗначение(ТекДанные.Получить("Количество"));
		СуммаЦен = ТипЧисла.ПривестиЗначение(ТекДанные.Получить("СуммаЦен"));
		СуммаЦенБезНДС = ТипЧисла.ПривестиЗначение(ТекДанные.Получить("СуммаЦенБезНДС"));
		Если Количество = 0
			И СуммаЦен = 0
