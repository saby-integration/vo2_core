...
Процедура ЗаполнитьРегистрационныеДанныеЛица(Кэш, Генератор, Данные, ИмяСтороны)
	...
	Если Данные.Свойство("СвЮЛ", ЗначениеДанные)
		...
		Генератор.Вставить(ИмяСтороны + ".СвЮл.ИНН",		"Идентиф");
		Генератор.Вставить(ИмяСтороны + ".СвЮл.КодСтраны",	"КодСтр");
		Генератор.Вставить(ИмяСтороны + ".СвЮл.НаимСтраны",	"НаимСтран");
