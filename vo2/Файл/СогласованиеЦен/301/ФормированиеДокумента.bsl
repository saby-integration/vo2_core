...
Функция ПолучитьДанныеИзДокумента1С(Кэш, Контекст) Экспорт
	...
	Попытка	
		...
		МодульПослеФормированияДокумента = МодульОбъектаКлиент().НайтиФункциюСеансаОбработки("сбисПослеФормированияДокумента", Вложение.Параметры.НаборМодулейДляФормата);
