	...
	Если Кэш.ини.Свойство("СчетФактураВыданныйПоставщику") Тогда
		...
		Для Каждого Стр Из ТаблДокПоставщики Цикл
			Если ЗначениеЗаполнено(Стр.ИсхСФ) Тогда
				...
				НастройкиЭДОДляРасчета.Вставить("РеквизитКодаНоменклатуры", МодульОбъектаКлиент().ПолучитьЗначениеПараметраСбис("РеквизитКодаНоменклатуры"));
				...
				ЗначениеИниСчетФактуры.Вставить("Настройки", Новый Структура("Значение,РассчитанноеЗначение", "", НастройкиДляРасчета));
