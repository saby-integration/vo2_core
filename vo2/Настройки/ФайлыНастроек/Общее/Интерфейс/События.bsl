...
Процедура КаталогНастроекПриИзменении(Элемент = Неопределено) Экспорт
	...
	ИдентификаторНастроек = Кэш.ФормаНастроек.сбисПолучитьИдентификаторНастроек(Кэш);
	Кэш.Парам.ИдентификаторНастроек = ИдентификаторНастроек;		
	МодульОбъектаКлиент().ИзменитьПараметрСбис("КаталогНастроек", ИдентификаторНастроек);
