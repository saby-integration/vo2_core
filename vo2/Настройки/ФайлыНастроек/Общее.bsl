...
Функция		ПроверитьЗначениеПараметра(знач ИмяПараметра, знач ЗначениеПараметра, СтруктураИниФайла, СлужебнаяСтруктура, ПараметрыФильтра)
	...
	Если	ТипЗнч(ЗначениеПараметра) = Тип("Структура") Тогда
		...
		Если	ЗначениеПараметра.Свойство("Тип", ЗначениеПроверить)
			...
			ПроверитьЗначениеПараметра_Тип(ИмяПараметра, ЗначениеПроверить, СтруктураИниФайла, СлужебнаяСтруктура, ПараметрыФильтра);
	...
	Возврат ПроверитьЗначениеПараметра_Значение(ИмяПараметра, ЗначениеПроверить, СтруктураИниФайла, СлужебнаяСтруктура, ПараметрыФильтра)	
			
КонецФункции

&НаСервереБезКонтекста
Процедура	ПроверитьЗначениеПараметра_Тип(ИмяПараметра, ЗначениеПараметра, СтруктураИниФайла, СлужебнаяСтруктура, ПараметрыФильтра)
	Перем ТекстОшибки;
	...
	ИначеЕсли Найти(ЗначениеПараметра, ",") Тогда
		...
		Исключение
			...
			Для НомерСтрокиПроверка = 1 По СтрЧислоСтрок(МножественныйТипПроверить) Цикл
				...
				ПроверитьЗначениеПараметра_Тип1С(ИмяПараметра, СтрПолучитьСтроку(МножественныйТипПроверить, НомерСтрокиПроверка), СтруктураИниФайла, СлужебнаяСтруктура);
	...
	Иначе
		...
		Тип1С = ПроверитьЗначениеПараметра_Тип1С(ИмяПараметра, ЗначениеПараметра, СтруктураИниФайла, СлужебнаяСтруктура);
...
&НаСервереБезКонтекста
Функция		ПроверитьЗначениеПараметра_Значение(ИмяПараметра, ЗначениеПараметра, СтруктураИниФайла, СлужебнаяСтруктура, ПараметрыФильтра)
	...
	Иначе
		...
		РезультатПроверкиОбъекта = ПроверитьЗначениеПараметра_Тип1С(ИмяПараметра, ЗначениеПараметра, СтруктураИниФайла, СлужебнаяСтруктура);
		...
		ИначеЕсли	НРег(ЗначениеПараметра) = "истина"
				Или НРег(ЗначениеПараметра) = "ложь" Тогда
...
&НаСервереБезКонтекста
Функция		ПроверитьЗначениеПараметра_Тип1С(ИмяПараметра, ЗначениеПараметра, СтруктураИниФайла, СлужебнаяСтруктура)
	
	ЗначениеПроверить = СтрЗаменить(ЗначениеПараметра, "'", "");
