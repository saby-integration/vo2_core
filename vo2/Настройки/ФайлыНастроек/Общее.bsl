...
Процедура	УстановитьИниКонфигурации_СопоставлениеНоменклатуры(ИниКонфигурации, ДопПараметры = Неопределено)
	...
	РасширенныйФункционалСопоставленияНоменклатуры = (МодульТекущий.ПолучитьЗначениеФичи("РасширенныйФункционалСопоставленияНоменклатуры") ИЛИ МодульТекущий.ПолучитьЗначениеФичи("РасширенныйФункционалСопоставленияНоменклатуры4100"));
