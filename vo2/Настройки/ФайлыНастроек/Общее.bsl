	...
	Попытка
		...
		Если НЕ ПараметрыФормированияКомандПечати.Свойство("СписокДокументов") Тогда
			...
			Для Каждого Элемент Из Кэш.Ини Цикл
				ИниНеУстановлена = Ложь;
				ЗначениеИни = Кэш.ФормаНастроек.Ини(Кэш, Элемент.Ключ, , ИниНеУстановлена);
				Если	Не ИниНеУстановлена
						И ЗначениеИни.Свойство("ЗапросСпискаДокументов")
						И ЗначениеИни.Свойство("Реестр1С_Тип") Тогда
					Реестр1С_Тип = Кэш.ОбщиеФункции.РассчитатьЗначение("Реестр1С_Тип", Новый Структура("Ини", ЗначениеИни));
