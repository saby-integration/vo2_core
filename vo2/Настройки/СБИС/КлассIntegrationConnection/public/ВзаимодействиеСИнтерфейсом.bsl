...
Процедура	КлассIntegrationConnection_ЗаполнитьРедакторИниПоКлассу(Кэш, КлассIntegrationConnection, ДопПараметры) Экспорт
	...
	Кэш.ФормаНастроекОбщее.Конфигурация = Кэш.ФормаНастроекОбщее.ОпределитьТипНастроекПоПрефиксу(НашаКонфигурация.service, Кэш.ФормаНастроекОбщее.СформироватьПрефиксСистемы(НашаКонфигурация));
