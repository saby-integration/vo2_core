...
Функция		_НовыйIntegrationConnection_ДанныеИнитКоннекшен(Кэш, ДанныеИнитКоннекшен, Отказ)
	...
	ПараметрыКонфигурации.version	= Кэш.ОбщиеФункции.СериализоватьВерсию(ДанныеИнитКоннекшен.ExtSysSettingsVersion, "ЧислоВСтроку");
	...
	КлассIntegrationConnection.Интеграция					= ДанныеИнитКоннекшен.Integration;
