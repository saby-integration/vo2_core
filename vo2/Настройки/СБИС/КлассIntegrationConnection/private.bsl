...
Функция		_КлассIntegrationConnection_Записать(Кэш, КлассIntegrationConnection, ДопПараметры, Отказ)
	...
	Если ЕстьИниКЗаписи
		И (КлассIntegrationConnection.ПараметрыРаботы.ТипНастроек = "Шаблон" // Ини только на шаблон!!!
			ИЛИ НЕ МодульОбъектаКлиент().ПолучитьЗначениеФичи("ВыгрузкаНастроекНаШаблон")) Тогда
