...
Функция		_КлассIntegrationConnection_ОсновныеПоля(Кэш)
	...
	("_класс, 						Статус,		ТипНастроек,	 Автообновление,	Изменен, ИнициированаШапка, ИнициированыДанные, ДатаИзмененияНастроек, Шаблон, Пользователь, ВерсияКонфиг, Демо"
	,"КлассIntegrationConnection",	"Новый",	"Стандартные",	Истина,		 		Ложь,	 Ложь,				Ложь,			  	ТекущаяДата());
