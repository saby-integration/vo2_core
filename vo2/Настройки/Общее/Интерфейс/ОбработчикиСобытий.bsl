...
Процедура СбисОбновитьЭлементы_РазделНастроек()
	...
	МестныйКэш.ГлавноеОкно.сбисЭлементФормы(ЭтаФорма, "ГруппаДействияНастройкиЛево").Видимость = МодульОбъектаКлиент().ПолучитьЗначениеПараметраСбис("ДоступныСерверныеНастройки");
