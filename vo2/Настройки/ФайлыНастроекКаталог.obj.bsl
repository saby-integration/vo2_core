...
#Область include_core_vo2_Настройки_Каталог_ВнешниеВызовы
#КонецОбласти
...
Функция		СбисПолучитьНастройкиСБИС(Кэш, Отказ=Ложь, ПродолжитьВыполнение=Истина)						Экспорт 
	...
	Если Кэш.Интеграция.ДоступныСерверныеНастройки() Тогда                      
...
#Область include_core_vo2_Настройки_СБИС_РаботаСМетками_Каталог
#КонецОбласти
...
#Область include_core_vo2_Настройки_Каталог_ВнутренниеВызовы_Общие
#КонецОбласти
