...
Процедура ЗаполнитьСтрокуСпискаПоИдПакета(СоставПакетаОбработать, СтрокаСпискаЗаполнить, ВыборкаПоСпискуИД, ПараметрыЗаполненияСвязи) 
	...
	СтрокаСпискаЗаполнить.Вставить("СвязанныеДокументы", Новый СписокЗначений);
	СтрокаСпискаЗаполнить.СвязанныеДокументы.ЗагрузитьЗначения(МассивДокументовПоИд[0].СвязанныеДокументы);
	...
	Пока ВыборкаЗаписей.СледующийПоЗначениюПоля("Ид") Цикл
		...
		Пока ВыборкаЗаписей.СледующийПоЗначениюПоля("ИдВложения") Цикл
			...
			Пока ВыборкаЗаписей.Следующий() Цикл
				...
				СтрокаДобавить = Новый Структура("Ссылка, Проведен, ПометкаУдаления, СвязанныеДокументы", ВыборкаЗаписей.Док1С);
				Попытка
				...
				СтрокаДобавить.СвязанныеДокументы = Новый Массив;
