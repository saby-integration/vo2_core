...
Функция сбисСписокДополнительныхОпераций(Кэш, ФормаПросмотра) Экспорт
	...
	ПараметрыПечать = Новый Структура("ИмяФункции, ТребуетРазбора", "СбисПечать", Ложь);

	СписокДопОпераций = Новый СписокЗначений;
	СписокДопОпераций.Добавить(ПараметрыПечать,						"Печать");
	...
	ФормаПросмотра.СервисДопОперацияПросмотра(СписокДопОпераций);	
