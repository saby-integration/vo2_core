...
Процедура УстановитьВидимостьЭлементовВформеПросмотра(ФормаПросмотра, СоставПакета, КэшПарам) Экспорт
	...
	Если МестныйКэш.ПараметрыСистемы.Клиент.УправляемоеПриложение Тогда
		МестныйКэш.ГлавноеОкно.СбисПолучитьЭлементФормы(ФормаПросмотра, "Контент.Загрузка").Видимость = Истина;
		МестныйКэш.ГлавноеОкно.СбисПолучитьЭлементФормы(ФормаПросмотра, "Контент.Прохождение").Видимость = Истина;		
		МестныйКэш.ГлавноеОкно.СбисПолучитьЭлементФормы(ФормаПросмотра, СбисПолноеИмяКолонки("ТабличнаяЧасть", "НоменклатураПоставщика")).Видимость = Истина;
	Иначе
		МестныйКэш.ГлавноеОкно.СбисПолучитьЭлементФормы(ФормаПросмотра, "Загрузка").Видимость = Истина;
		МестныйКэш.ГлавноеОкно.СбисПолучитьЭлементФормы(ФормаПросмотра, "Прохождение").Видимость = Истина;		
		МестныйКэш.ГлавноеОкно.СбисПолучитьЭлементФормы(ФормаПросмотра, "НадписьТипДокумента").Видимость = Истина;
		МестныйКэш.ГлавноеОкно.СбисПолучитьЭлементФормы(ФормаПросмотра, СбисПолноеИмяКолонки("ТабличнаяЧасть", "Название")).Видимость = Истина;
	КонецЕсли;
	...
	МестныйКэш.ГлавноеОкно.СбисПолучитьЭлементФормы(ФормаПросмотра, "СинонимДокумента").Видимость	= Истина;
	МестныйКэш.ГлавноеОкно.СбисПолучитьЭлементФормы(ФормаПросмотра, "ГруппаАбонЯщик").Видимость		= Ложь;
	
	МестныйКэш.ГлавноеОкно.СбисПолучитьЭлементФормы(ФормаПросмотра, СбисПолноеИмяКолонки("ТаблицаДокументов", "Статус")).Видимость			= Ложь;
	МестныйКэш.ГлавноеОкно.СбисПолучитьЭлементФормы(ФормаПросмотра, СбисПолноеИмяКолонки("ТаблицаДокументов", "СтатусКартинка")).Видимость	= Ложь;
	МестныйКэш.ГлавноеОкно.СбисПолучитьЭлементФормы(ФормаПросмотра, СбисПолноеИмяКолонки("ТаблицаДокументов", "Шифрование")).Видимость		= Ложь;
	МестныйКэш.ГлавноеОкно.СбисПолучитьЭлементФормы(ФормаПросмотра, СбисПолноеИмяКолонки("ТаблицаДокументов", "Удалить")).Видимость			= Ложь;
	МестныйКэш.ГлавноеОкно.СбисПолучитьЭлементФормы(ФормаПросмотра, СбисПолноеИмяКолонки("ТаблицаДокументов", "Отмечен")).Видимость			= Истина;
	
	МестныйКэш.ГлавноеОкно.СбисПолучитьЭлементФормы(ФормаПросмотра, СбисПолноеИмяКолонки("ТабличнаяЧасть", "Идентификатор")).Видимость				= Ложь;
	МестныйКэш.ГлавноеОкно.СбисПолучитьЭлементФормы(ФормаПросмотра, СбисПолноеИмяКолонки("ТабличнаяЧасть", "ХарактеристикаПоставщика")).Видимость	= Истина;
	МестныйКэш.ГлавноеОкно.СбисПолучитьЭлементФормы(ФормаПросмотра, СбисПолноеИмяКолонки("ТабличнаяЧасть", "ЕдИзм")).Видимость						= Истина;
	МестныйКэш.ГлавноеОкно.СбисПолучитьЭлементФормы(ФормаПросмотра, СбисПолноеИмяКолонки("ТабличнаяЧасть", "Количество")).Видимость					= Истина;
	МестныйКэш.ГлавноеОкно.СбисПолучитьЭлементФормы(ФормаПросмотра, СбисПолноеИмяКолонки("ТабличнаяЧасть", "Цена")).Видимость						= Истина;
	МестныйКэш.ГлавноеОкно.СбисПолучитьЭлементФормы(ФормаПросмотра, СбисПолноеИмяКолонки("ТабличнаяЧасть", "СуммаБезНал")).Видимость				= Истина;
	МестныйКэш.ГлавноеОкно.СбисПолучитьЭлементФормы(ФормаПросмотра, СбисПолноеИмяКолонки("ТабличнаяЧасть", "СтавкаНДС")).Видимость					= Истина;
	МестныйКэш.ГлавноеОкно.СбисПолучитьЭлементФормы(ФормаПросмотра, СбисПолноеИмяКолонки("ТабличнаяЧасть", "СуммаНДС")).Видимость					= Истина;
	МестныйКэш.ГлавноеОкно.СбисПолучитьЭлементФормы(ФормаПросмотра, СбисПолноеИмяКолонки("ТабличнаяЧасть", "Сумма")).Видимость						= Истина;
	...
	КонецЕсли;
	ЭлементТулБар = МестныйКэш.ГлавноеОкно.СбисПолучитьЭлементФормы(ФормаПросмотра, "ТулБар");
	ЭлементТулБар.ТекущаяСтраница = МестныйКэш.ГлавноеОкно.СбисПолучитьЭлементФормы(ЭлементТулБар, "Полученные");
	МестныйКэш.ГлавноеОкно.СбисПолучитьЭлементФормы(ФормаПросмотра, "ПакетКомментарий").Доступность = Ложь;
КонецПроцедуры
