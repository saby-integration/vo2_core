...
Процедура ПоказатьДокумент(Кэш, ТекущаяСтрока) Экспорт
	...
	Попытка
		Модуль.ПоказатьДокумент(Кэш, ТекущаяСтрока);
	Исключение
		МодульОбъектаКлиент().СообщитьСбисИсключение(ИнформацияОбОшибке(), "Раздел_Справочники_Шаблон.ПоказатьДокумент");
	КонецПопытки;
...
Функция ПодготовитьСтруктуруДокумента(СтрокаСпискаДокументов, Кэш) Экспорт
	...
	Модуль = МодульОбъектаКлиент().НайтиФункциюСеансаОбработки("ПодготовитьСтруктуруДокумента", МодулиРаздела);
	
	Попытка
		Возврат Модуль.ПодготовитьСтруктуруДокумента(СтрокаСпискаДокументов, Кэш);
	Исключение
		МодульОбъектаКлиент().СообщитьСбисИсключение(ИнформацияОбОшибке(), "Раздел_Справочники_Шаблон.ПодготовитьСтруктуруДокумента");
	КонецПопытки;
