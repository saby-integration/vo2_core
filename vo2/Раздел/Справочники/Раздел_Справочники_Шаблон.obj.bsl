...
Функция ТипФормируемогоДокумента(Кэш, ПараметрыРасчета) Экспорт
	...
	ТипыПакета = Кэш.ОбщиеФункции.РассчитатьЗначение("РеестрСБИС_Тип", ИниДокумента, Кэш);
	...
	КонецЕсли;
	ПодтипПакета = Кэш.ОбщиеФункции.РассчитатьЗначение("РеестрСБИС_Подтип", ИниДокумента, Кэш);
