...
Процедура Disconnected(РезультатВызова, ПараметрыОбработки) Экспорт 
	...
	Если МодульОбъектаКлиент.ПолучитьЗначениеПараметраСБИС("ОбменВключен") Тогда
		...
		ОтложенноеОткрытие	= МодульОбъектаКлиент.ПолучитьОтложенноеДействие("ОткрытьФормуНастроекСоединения");
		Если ОтложенноеОткрытие = Неопределено Тогда
			
			ПараметрыОткрытияФормы = Новый Структура();
			ПараметрыОткрытияФормы.Вставить("ИмяПроцедуры",				"ОткрытьФормуНастроекСоединения");
			ПараметрыОткрытияФормы.Вставить("ИдентификаторДействия",	"ОткрытьФормуНастроекСоединения");
			ПараметрыОткрытияФормы.Вставить("Модуль",					МодульОбъектаКлиент);  
