...
Функция Включить(Кэш, ДопПараметры=Неопределено, Отказ=Ложь) Экспорт
	...
	// Создать экземпляр формы старого SDK для вызовов
...
Функция ПолучитьМодульИнтеграции(Кэш, ДопПараметры, Отказ) Экспорт
	...
	Иначе
		...
		Исключение
			...
			Отказ = Истина;
			Возврат МодульОбъектаКлиент().НовыйСбисИсключение(ИнформацияОбОшибке(), "ExtSDK2.ПолучитьМодульИнтеграции", 762, "Версия системы не поддерживается", "Обновите Saby плагин.");
