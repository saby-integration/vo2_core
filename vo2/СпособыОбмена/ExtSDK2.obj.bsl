...
Процедура СбисУстановитьВремяОжидания(Кэш, ВремяОжидания) Экспорт
	Кэш.СБИС.ДанныеИнтеграции.Объекты.Форма_ExtSDK.СбисУстановитьВремяОжидания(Кэш, ВремяОжидания);
КонецПроцедуры
...
Функция Включить(Кэш, ДопПараметры=Неопределено, Отказ=Ложь) Экспорт
	...
	// Включаем обмен чтобы в МОК().ГлобальныйКэш_ЧтениеОтветовИВызовСобытий был обработан ответ от Плагина
	...
	Кэш.СБИС.ДанныеИнтеграции.Объекты.Вставить("Форма_" + СведенияОбИнтеграции.Имя, ЭтаФорма);
...
Функция СБИС_СписокДокументов(Кэш, filter, ДопПараметры, Отказ) Экспорт
	...
	Возврат Кэш.СБИС.ДанныеИнтеграции.Объекты.Форма_ExtSDK.СБИС_СписокДокументов(Кэш, filter, ДопПараметры, Отказ);
