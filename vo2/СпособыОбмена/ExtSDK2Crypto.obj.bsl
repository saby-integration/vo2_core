...
#Область include_core_vo2_СпособыОбмена_ExtSDKCrypto_2_WriteDocumentEx
#КонецОбласти

#Область include_core_vo2_СпособыОбмена_ExtSDKCrypto_2_ExecuteActionEx  
#КонецОбласти

#Область include_core_vo2_СпособыОбмена_ExtSDKCrypto_2_СобытияОтправки
#КонецОбласти
