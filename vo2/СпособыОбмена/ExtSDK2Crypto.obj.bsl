...
функция ExtSys_FeatureIsOn(ПараметрыФичи, ДопПараметрыВызова) экспорт
	Кэш = ДопПараметрыВызова.Кэш;
	Возврат Кэш.СБИС.ДанныеИнтеграции.Объекты.Форма_ExtSDK2.ExtSys_FeatureIsOn(ПараметрыФичи, ДопПараметрыВызова);
КонецФункции
...
Функция MappingObject_List(Кэш, ДопПоля, Фильтр, Навигация, Отказ = Ложь) Экспорт 
	...
	Возврат Кэш.СБИС.ДанныеИнтеграции.Объекты.Форма_ExtSDK2.MappingObject_List(Кэш, ДопПоля, Фильтр, Навигация, Отказ)
...
Функция Connector_Prepare(Кэш, ПараметрыВызова, Отказ) Экспорт
	Возврат Кэш.СБИС.ДанныеИнтеграции.Объекты.Форма_ExtSDK2.Connector_Prepare(Кэш, ПараметрыВызова, Отказ);	
КонецФункции

//Подготовка данных по загружаемым в 1С объектам на сервисе IntegrationConfig порционно
&НаКлиенте
Функция ExtSyncDoc_Prepare(Кэш, ПараметрыВызова, Отказ) Экспорт
	Возврат Кэш.СБИС.ДанныеИнтеграции.Объекты.Форма_ExtSDK2.ExtSyncDoc_Prepare(Кэш, ПараметрыВызова, Отказ);	
КонецФункции

//Получение объекта на загрузку в 1С
&НаКлиенте
Функция ExtSyncDoc_GetObjectForExecute(Кэш,ИдентификаторПосылки, Отказ) Экспорт
	Возврат Кэш.СБИС.ДанныеИнтеграции.Объекты.Форма_ExtSDK2.ExtSyncDoc_GetObjectForExecute(Кэш,ИдентификаторПосылки, Отказ);
КонецФункции
...
Функция ExtSyncDoc_CalcObjectForExecute(Кэш, СтруктураОбъекта, ИдентификаторПосылки, ИмяИни, Отказ) Экспорт
	...
	Возврат Кэш.СБИС.ДанныеИнтеграции.Объекты.Форма_ExtSDK2.ExtSyncDoc_CalcObjectForExecute(Кэш, СтруктураОбъекта, ИдентификаторПосылки, ИмяИни, Отказ);
...
Функция ExtSyncDoc_Write(Кэш, ПараметрыМетода, Отказ = Ложь) Экспорт        
	...
	Возврат Кэш.СБИС.ДанныеИнтеграции.Объекты.Форма_ExtSDK2.ExtSyncDoc_Write(Кэш, ПараметрыМетода, Отказ);
...
Функция ExtSyncDoc_Execute(Кэш, ПараметрыМетода, Отказ = Ложь) Экспорт         
	...
	Возврат Кэш.СБИС.ДанныеИнтеграции.Объекты.Форма_ExtSDK2.ExtSyncDoc_Execute(Кэш, ПараметрыМетода, Отказ);
...
Функция API3_GetSbisObject(Кэш, ПараметрыМетода, ДопПараметры, Отказ = Ложь) Экспорт  
	...
	Возврат Кэш.СБИС.ДанныеИнтеграции.Объекты.Форма_ExtSDK2.API3_GetSbisObject(Кэш, ПараметрыМетода, ДопПараметры, Отказ);
...
Функция API3_ExtSyncDocRead(Кэш, ПараметрыМетода, ДопПараметры, Отказ = Ложь) Экспорт 
	...
	Возврат Кэш.СБИС.ДанныеИнтеграции.Объекты.Форма_ExtSDK2.API3_ExtSyncDocRead(Кэш, ПараметрыМетода, ДопПараметры, Отказ);
...
Функция API3_FindSbisObject(Кэш, ПараметрыМетода, ДопПараметры, Отказ = Ложь) Экспорт
	...
	Возврат Кэш.СБИС.ДанныеИнтеграции.Объекты.Форма_ExtSDK2.API3_FindSbisObject(Кэш, ПараметрыМетода, ДопПараметры, Отказ);
...
Функция MappingObject_UpdateFromData(Кэш, ПараметрыМетода, ДопПараметры, Отказ = Ложь) Экспорт        
	...
	Возврат Кэш.СБИС.ДанныеИнтеграции.Объекты.Форма_ExtSDK2.MappingObject_UpdateFromData(Кэш, ПараметрыМетода, ДопПараметры, Отказ); 
...
Функция СБИС_ПолучитьСопоставлениеСторон(Кэш, ПараметрыДанныеСторон, ДопПараметры=Неопределено, Отказ) Экспорт
	Возврат Кэш.СБИС.ДанныеИнтеграции.Объекты.Форма_ExtSDK2.СБИС_ПолучитьСопоставлениеСторон(Кэш, ПараметрыДанныеСторон, ДопПараметры, Отказ);
КонецФункции
...
Функция ПолучитьСписокСертификатовПоФильтру(Кэш, filter=Неопределено, Отказ)
	Возврат Кэш.СБИС.ДанныеИнтеграции.Объекты.Форма_ExtSDK2.ПолучитьСписокСертификатовПоФильтру(Кэш, filter)	
КонецФункции

&НаКлиенте
Функция ПолучитьСписокЛокальныхСертификатов(Кэш, filter=Неопределено) Экспорт
	Возврат Кэш.СБИС.ДанныеИнтеграции.Объекты.Форма_ExtSDK2.ПолучитьСписокЛокальныхСертификатов(Кэш, filter);
КонецФункции
...
#Область include_core2_vo2_СпособыОбмена_ExtSDKCrypto_2_ВнешниеОбертки
#КонецОбласти
...
#Область include_core2_vo2_СпособыОбмена_ExtSDKCrypto_2_WriteDocumentEx
#КонецОбласти

#Область include_core2_vo2_СпособыОбмена_ExtSDKCrypto_2_ExecuteActionEx  
#КонецОбласти

#Область include_core2_vo2_СпособыОбмена_ExtSDKCrypto_2_СобытияОтправки
#КонецОбласти
...
Функция ОбновитьЗаписьСопоставления(Кэш, Фильтр, Данные, Отказ) Экспорт
	Возврат Кэш.СБИС.ДанныеИнтеграции.Объекты.Форма_ExtSDK2.ОбновитьЗаписьСопоставления(Кэш, Фильтр, Данные, Отказ);
КонецФункции
