...
Функция СведенияОбИнтеграции() Экспорт
	...
	"SabyPluginConnector", "", ЭтаФорма, ПараметрыИнтеграции);
...
Функция  ПослеПодключенияКомпоненты(Компонента, ДопПараметры = Неопределено) Экспорт
	...
	ПараметрыВключения = Новый Структура("ВремяОжиданияОтвета, ВремяОжиданияОтвета_Отправка, КоличествоПотоков, ИнтеграцияИмя, Компонента",
																							60, 120, 10, "SabyPluginConnector", Компонента);
