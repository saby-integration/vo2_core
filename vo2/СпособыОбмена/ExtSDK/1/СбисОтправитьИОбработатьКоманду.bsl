...
Процедура СбисОтправитьИОбработатьКоманду_Ответ(РезультатВызова, ПараметрыОбработки) Экспорт
	...
	ДанныеКоманды = РезультатВызова.Данные;
	Если ТипЗнч(ДанныеКоманды) = Тип("Структура") И ДанныеКоманды.Свойство("Result") Тогда
		РезультатВызова.Данные = РезультатВызова.Данные.Result;
	ИначеЕсли ТипЗнч(ДанныеКоманды) = Тип("Соответствие") И ДанныеКоманды["Result"] <> Неопределено Тогда
		РезультатВызова.Данные = РезультатВызова.Данные["Result"];	
	КонецЕсли;	
