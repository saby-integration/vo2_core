...
#Область include_core_vo2_СпособыОбмена_ExtSDK_2_ВнешниеОбертки_ПрикладнаяСтатистика
#КонецОбласти

#Область include_core_vo2_СпособыОбмена_ExtSDK_2_ВнешниеОбертки_СопоставлениеНоменклатуры
#КонецОбласти
