...
#Область include_core_vo2_СпособыОбмена_ExtSDKCrypto_2_ВнешниеОбертки_Прослеживаемость  
#КонецОбласти   

#Область include_core_vo2_СпособыОбмена_ExtSDKCrypto_2_ВнешниеОбертки_Маркировка 
#КонецОбласти 

#Область include_core_vo2_СпособыОбмена_ExtSDKCrypto_2_ВнешниеОбертки_ПрикладнаяСтатистика
#КонецОбласти
