...
Функция Включить(Кэш, ДопПараметры=Неопределено, Отказ=Ложь) Экспорт
	...
	Кэш.СБИС.ПараметрыИнтеграции.ИнтеграцияИмя = "Каталог";
...
#Область include_core_vo2_СпособыОбмена_ИнтеграцияКаталог_Прочее
#КонецОбласти

#Область include_core_vo2_СпособыОбмена_ИнтеграцияКаталог_ВнешниеОбертки
#КонецОбласти

#Область include_core_vo2_СпособыОбмена_ИнтеграцияКаталог_ВнешниеОбертки_АсинхроннаяОтправка
#КонецОбласти
