...
Функция Включить(Кэш, ДопПараметры=Неопределено, Отказ=Ложь) Экспорт
	...
	МодульОбъектаКлиент().ИзменитьПараметрСбис("ИнтеграцияИмя",			"ИнтеграцияКаталог");
...
Функция СведенияОбИнтеграции() Экспорт
	...
	"Каталог",	МодульОбъектаКлиент().ПолучитьЗначениеПараметраСБИС("КаталогОбмена"), ЭтаФорма, ПараметрыИнтеграции);
