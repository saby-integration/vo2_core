...
Функция СбисОценитьРезультатВключения(Кэш, Результат, ДопПараметры, Отказ) Экспорт
	Если Отказ Тогда
		...
		ИначеЕсли Результат.code = 775 Тогда
			...
			ПараметрыСообщения.Вставить("Текст",		Результат.message + " (" + Результат.details + ")");
			ПараметрыСообщения.Вставить("АдресСсылка",	"https://online.sbis.ru/reg/?check=ExtSDK2");
		КонецЕсли;
...
#Область include_core_vo2_СпособыОбмена_ExtSDK_1_ВнешниеОбертки
#КонецОбласти

#Область include_core_vo2_СпособыОбмена_ExtSDK_1_АсинхронныеСобытия
#КонецОбласти

#Область include_core_vo2_СпособыОбмена_ExtSDK_1_XMLКонвертер
#КонецОбласти
...
#Область include_core_vo2_СпособыОбмена_ExtSDK_1_СбисОтправитьИОбработатьКоманду
#КонецОбласти

#Область include_core_vo2_СпособыОбмена_ExtSDK_1_old_ЧтениеОтветов
#КонецОбласти
