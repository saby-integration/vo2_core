...
Функция СБИСПлагин_GetModule(Кэш, ИмяМодуля, Отказ) Экспорт
	...
	Исключение
		...
		Возврат МодульОбработкиВызова.НовыйСбисИсключение(ИнформацияОбОшибке(), "ExtSDK2.СБИСПлагин.GetModule" ,762, "Версия системы не поддерживается", "Обновите Saby плагин.");
