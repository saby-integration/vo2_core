...
#Область include_core_vo2_СпособыОбмена_NativeAPI_ВнешниеОбертки_АсинхронноеВыполнениеДействия
#КонецОбласти

#Область include_core_vo2_СпособыОбмена_NativeAPI_ВнешниеОбертки_АсинхроннаяОтправка
#КонецОбласти
...
#Область include_core_vo2_СпособыОбмена_NativeAPI_ВнешниеОбертки_ПрикладнаяСтатистика
#КонецОбласти
