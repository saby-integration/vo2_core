...
Процедура WriteAttachment_Message(РезультатВызова, ПараметрыОбработки) Экспорт
	...
	Если НЕ ПараметрыОбработки.Команда.АргументВызова.Свойство("НеЗапускатьВДокументооборот")
		ИЛИ НЕ ПараметрыОбработки.Команда.АргументВызова.НеЗапускатьВДокументооборот Тогда 
