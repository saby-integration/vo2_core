...
Функция РаботаСДБФ_ПодключитьСоединениеБД(РаботаСДБФ, СоединениеСДБФ)
	...
	Если Не ЕстьКонтактБД Тогда
		ВызватьСбисИсключение(, "ADODB.Connection.Open", 776,,"Не удалось установить подключение к DBF в " + СоединениеСДБФ.Путь,, "https://sbis.ru/help/integration/catalog/driver_not_found");
	КонецЕсли;
