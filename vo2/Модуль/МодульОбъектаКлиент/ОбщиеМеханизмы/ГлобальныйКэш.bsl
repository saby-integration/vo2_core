...
Функция	ГлобальныйКэш_ЧтениеОтветовИВызовСобытий(Сбис3КомандыОжидаются=Неопределено) Экспорт
	...
	Иначе
		...
		ИсключениеЗавершенОбмен	= НовыйСбисИсключение(741, "МодульОбъектаКлиент.ГлобальныйКэш_ЧтениеОтветовИВызовСобытий",,, "Не включен обмен со СБИС.");
...
Процедура НастроитьКэшОбработки(МодульГлавноеОкно) Экспорт 
	...
	ОбновитьПараметрГлобальногоМодуля("ФункцииДокументов",	СбисОбщиеФункции);
