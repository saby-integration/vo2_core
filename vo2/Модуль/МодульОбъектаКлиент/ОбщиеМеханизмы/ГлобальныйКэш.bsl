...
Функция	ГлобальныйКэш_ЧтениеОтветовИВызовСобытий(Сбис3КомандыОжидаются=Неопределено) Экспорт
	...
	Если СобытиеОбменаОшибка = Неопределено Тогда
		...
		Для Каждого ОтложенныйОтвет Из ГлобальныйКэш.СБИС.ДанныеИнтеграции.ОтложенныеОтветы Цикл

			Сбис3СобытиеОтвет = ОтложенныйОтвет.Значение;
			ГлобальныйКэш.СБИС.ДанныеИнтеграции.ОтложенныеОтветы.Удалить(ОтложенныйОтвет.Ключ);
