...
Функция ИспользоватьГенераторДляВложения(ВложениеДанные) Экспорт
	...
	Результат = ГлобальныйКэш.Парам.ИспользоватьГенератор = Истина
			И	ГлобальныйКэш.СБИС.ПараметрыИнтеграции.ГенераторФЭД
			И	(	ВложениеДанные.Свойство("ИспользоватьГенератор",			ГенераторНаВложении)
				Или	ВложениеДанные.Параметры.Свойство("ИспользоватьГенератор",	ГенераторНаВложении))
