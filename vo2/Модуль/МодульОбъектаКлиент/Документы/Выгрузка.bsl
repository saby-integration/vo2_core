...
Функция СгенерироватьИсходящийПакет(ПакетВходящий, ПараметрыГенерацииПакета)
	Перем РегламентНазвание, ПолныйСоставПакета, ОснованиеДляПакета; 
	...
	ИначеЕсли Не ПакетВходящий.Свойство("Конверт", ОснованиеДляПакета) Тогда
		
		ОснованиеДляПакета	= ПакетВходящий.Вложение[0];
