...
Процедура ДействияПриСтарте_Общее(ПараметрыЗапуска)
	...
	Если СтрНачинаетсяС82(Кэш.ПараметрыСистемы.Клиент.ВерсияПриложения, "8.2.") Тогда
		ПоколениеПлатформы = "8.2";
	ИначеЕсли СтрНачинаетсяС82(Кэш.ПараметрыСистемы.Клиент.ВерсияПриложения, "8.3.") Тогда
		ПоколениеПлатформы = "8.3";
	ИначеЕсли СтрНачинаетсяС82(Кэш.ПараметрыСистемы.Клиент.ВерсияПриложения, "8.5.") Тогда
