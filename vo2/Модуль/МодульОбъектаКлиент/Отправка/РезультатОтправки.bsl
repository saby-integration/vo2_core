...
Функция РезультатОтправки_Пустой(ВерсияЭкземпляра = 2) Экспорт
	...
	РезультатОтправки.Вставить("ТребуетсяПользовательскоеДействие",	Новый Массив); // ВААл. Для накомпления ошибок, которые можно решить пользовательским действием
...
Процедура РезультатОтправки_МассоваяОтправка_Завершение(АргументЗавершения="Завершено", РезультатОтправки) Экспорт 
	...
	ИначеЕсли	АргументЗавершения = "ОжиданиеОтветов" Тогда
		...
		ПодключитьОтложенноеДействие(ОтложенноОбновитьПрогрессБар, Новый Структура("Аргумент", РезультатОтправки));
