...
#Область include_core_vo2_Модуль_МодульОбъектаКлиент_Отправка_РезультатОтправки_private
#КонецОбласти

#Область include_core_vo2_Модуль_МодульОбъектаКлиент_Документы_РезультатОтправки_ОбработкаОтветов
#КонецОбласти

#Область include_core_vo2_Модуль_МодульОбъектаКлиент_Документы_РезультатОтправки_ЗаписьИтогов
#КонецОбласти

#Область include_core_vo2_Модуль_МодульОбъектаКлиент_Документы_РезультатОтправки_Замер
#КонецОбласти
