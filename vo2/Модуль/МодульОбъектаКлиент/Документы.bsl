...
#Область include_core2_vo2_Модуль_МодульОбъектаКлиент_Документы_ОбщиеФункции
#КонецОбласти
...
#Область include_core2_vo2_Модуль_МодульОбъектаКлиент_Документы_УтверждениеОтклонение
#КонецОбласти
