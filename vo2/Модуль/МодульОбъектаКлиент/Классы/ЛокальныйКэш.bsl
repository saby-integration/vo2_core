...
Функция	НовыйДанныеИнтеграции(ПараметрыКонструктора = Неопределено) Экспорт
	...
	Возврат Новый Структура("Подписки, Потоки, НеизвестныеОтветы", Новый Соответствие, Новый Соответствие, Новый Соответствие);
...
Функция НовыйТекущийСеанс_Пустой()
	...
	НаборМодулейСеанса		= Новый Структура("Интеграция, ФункцииДокументов, Настройки, НастройкиСБИС, МодульСопоставлениеНоменклатуры, МодульХраненияСтатусов");
	...
	НаборПараметровСеанса.Вставить("ОпцияКэшироватьФормуИнтерфейса",		Истина);
...
Функция СписокДоступныхСерверовСБИС() Экспорт
	...
	СписокДоступныхСерверов.Добавить("https://online.saby.ru/", "online.saby.ru");
	...
	Если ПолучитьЗначениеПараметраСбис("РежимОтладки") = Истина Тогда 
		...
		СписокДоступныхСерверов.Добавить("https://test-online.saby.ru/", "test-online.saby.ru");
