...
Функция НовыйТекущийСеанс_Пустой()
	...
	ОписаниеКонфигурации	= Новый Структура("ТипыПолей1С, ТипыПолейФильтра", Новый Структура, Новый Структура);
...
// Функция - Сожержит список доступных способов обработки документов для диалогов
// 
// Возвращаемое значение:
