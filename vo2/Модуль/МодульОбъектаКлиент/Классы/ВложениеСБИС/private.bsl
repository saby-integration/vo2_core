...
Функция ВложениеСБИС_Выгрузить_ЗаписьНаБЛ(ВложениеСБИС, ДопПараметры)
	...
	Если СбисШифрование Тогда
		...
		Если ПолучитьЗначениеПараметраСбис("ШифроватьВыборочно") Тогда
			...
			Если ВложениеСБИС.Свойство("Шифрование") И ВложениеСБИС.Шифрование = Истина Тогда
	...
	ИначеЕсли ВложениеСБИС.Свойство("Зашифрован") Тогда
		
		// может быть в случае пересылки зашифрованных пакетов
		attachment.Вставить("Зашифрован", ВложениеСБИС.Зашифрован);
