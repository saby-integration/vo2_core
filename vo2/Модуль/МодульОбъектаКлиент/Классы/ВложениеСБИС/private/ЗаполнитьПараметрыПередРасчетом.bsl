...
Процедура яВложениеСБИС_Заполнить_Файл(ВложениеСБИС, ДанныеЗаполнить) 
	Перем ФайлЗначение, лШифрование, НазваниеФайла, ИмяФайла;
	
	Если ДанныеЗаполнить.Свойство("Файл", ФайлЗначение) Тогда 
		
		ПолноеИмяФайла	= ФайлЗначение.ПолноеИмя;
		ИмяФайла		= ФайлЗначение.Имя;
		НазваниеФайла	= ФайлЗначение.Имя;
		
	Иначе
		
		ПолноеИмяФайла	= ДанныеЗаполнить.ПолноеИмяФайла;
		Если Не ДанныеЗаполнить.Свойство("ИмяФайла", ИмяФайла) Тогда
			
			ФайлОписание = Новый Файл(ПолноеИмяФайла);
			ИмяФайла	 = ФайлОписание.Имя;
			
		КонецЕсли;
		
		Если Не ДанныеЗаполнить.Свойство("Название", НазваниеФайла) Тогда
	...
	ВложениеСБИС_Установить(ВложениеСБИС, "Название",		НазваниеФайла);
