...
Процедура ВложениеСБИС_Обновить_ДанныеДокументовПоУмолчанию(ВложениеСБИС, Изменения, ДопПараметры = Неопределено)	
	...
	ВложениеСБИС.Просмотр.РазделСохранен = Изменения.ЗапомнитьВыборДокумента;
	...
	ИначеЕсли НастройкиИни.Свойство("Загрузка", ПараметрДляИзменения) Тогда
	
		// Параметр проинициализирован
	
	Иначе
	
		НастройкиИни.Вставить("Загрузка", Новый Структура);
	    ПараметрДляИзменения = НастройкиИни.Загрузка; 
	...
	ИзменитьПараметрПользователя("НастройкиИни", НастройкиИни);
