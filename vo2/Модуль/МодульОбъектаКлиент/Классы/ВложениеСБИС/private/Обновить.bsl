...
Процедура ВложениеСБИС_Обновить_Статус(ВложениеСБИС, ТекущиеИзменения, ДопПараметры)
	...
	//Доступные статусы
	Если		Найти(",разобран,", "," + НРег(СтатусУстановить) + ",") Тогда
		
		ВложениеСБИС.СтатусыВложения.Вставить("Общий", "Разобран");
		ВложениеСБИС.СтатусыВложения.Ини = Истина;
		
	ИначеЕсли	Найти(",ошибка,незаполненыполя,", "," + НРег(СтатусУстановить) + ",") Тогда
