...
Процедура СформироватьРасхождениеСДокументомСБИС(ПараметрыВходящие, ДопПараметры) Экспорт 
	...
	Вложение = ПараметрыРасхождения.Вложение;
	Если ПолучитьЗначениеФичи("РасширенныйФункционалСопоставленияНоменклатуры_ОбратноеСопоставление") 
		И Вложение.Свойство("НоменклатураСопоставлена") И НЕ Вложение.НоменклатураСопоставлена Тогда
