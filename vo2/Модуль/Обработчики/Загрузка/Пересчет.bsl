...
Функция сбисРассчитатьЦеныСтавкиИСуммыНДСДляСтрокТЧТоварыДокумента_УТ11(Документ, ПересчитыватьНДСПоДанным1С, ПересчитыватьЦеныПоДанным1С) Экспорт
	...
	ВозможныеИменаРеквизитаЦен.Вставить("ВидЦеныПоставщика", СбисСуществуетОбъектКонфигурацииСервер("ВидЦеныПоставщика", ДопПараметрыПроверки));
	ВозможныеИменаРеквизитаЦен.Вставить("ВидЦеныКлиента", СбисСуществуетОбъектКонфигурацииСервер("ВидЦеныКлиента", ДопПараметрыПроверки));
	ВозможныеИменаРеквизитаЦен.Вставить("ВидЦены", СбисСуществуетОбъектКонфигурацииСервер("ВидЦены", ДопПараметрыПроверки));
	ВозможныеИменаРеквизитаЦен.Вставить("ВидЦен", СбисСуществуетОбъектКонфигурацииСервер("ВидЦен", ДопПараметрыПроверки));
		...
		Если (ПересчитыватьЦеныПоДанным1С = 1
			 ...
			 Для каждого ИмяРеквизита Из ВозможныеИменаРеквизитаЦен Цикл
				Если ИмяРеквизита.Значение Тогда
				   ...
				   СтруктураДействий.Вставить("ЗаполнитьВидЦены", Новый Структура("ВидЦены", Документ.Соглашение[ИмяРеквизита.Ключ]));
				   Прервать;
