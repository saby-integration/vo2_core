...
Функция СбисСвойствоУстановлено(СвойствоПараметр, СвойствоЗначение, ДокументСсылка, НоваяРедакция, ДополнительныеПараметры, Отказ)
	...
	Исключение
		...
		Отказ = Истина;
		ТекстОшибки = "Ошибка создания дополнительных свойств";
		Возврат МодульОбъектаСервер().НовыйСбисИсключение(ИнформацияОбОшибке(), "Статусы_Регистры.СбисСвойствоУстановлено", 767301,,ТекстОшибки);
