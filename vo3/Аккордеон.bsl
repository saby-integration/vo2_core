...
Процедура ВернутьРезультат(Результат)
	...
	#Если ВебКлиент Тогда
		ЭлементыФормочки.АккордеонHTML.Документ.domConnector.resolve(Результат);
	#Иначе
		ЭлементыФормочки.АккордеонHTML.Документ[РеквизитОбъектаДокумента].resolve(Результат);
	#КонецЕсли 			
КонецПроцедуры
...
Процедура ВернутьОшибку(Ошибка)
	ЭлементыФормочки = ПолучитьЭлементыФормы();
	#Если ВебКлиент Тогда
		ЭлементыФормочки.АккордеонHTML.Документ.domConnector.reject(Ошибка);
	#Иначе
		ЭлементыФормочки.АккордеонHTML.Документ[РеквизитОбъектаДокумента].domConnector.reject(Ошибка);
	#КонецЕсли 
КонецПроцедуры
